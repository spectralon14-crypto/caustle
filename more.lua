...
local THEME = {
    ...
    Accent = Color3.fromRGB(114, 100, 255), -- font accent tetap ungu
    PlatformAccent = Color3.fromRGB(255, 196, 64), -- aksen platform kuning
...
LStroke.Color = THEME.PlatformAccent
...
Stroke.Color = THEME.PlatformAccent
...
KStroke.Color = THEME.PlatformAccent
...
UserInputService.InputBegan:Connect(function(input)
    ...
    if input.UserInputType == Enum.UserInputType.Keyboard then
        ...
        if Keys[char] then
            Tween(Keys[char], {BackgroundColor3 = THEME.PlatformAccent}, 0.1)
        end
        if input.KeyCode == Enum.KeyCode.Space then
            Tween(Keys[" "], {BackgroundColor3 = THEME.PlatformAccent}, 0.1)
        end
    end
end)
...
SliderFill.BackgroundColor3 = THEME.PlatformAccent
...
ThinkFill.BackgroundColor3 = THEME.PlatformAccent
...
local function CreateCheckbox(text, pos, key)
    ...
    container.MouseButton1Click:Connect(function()
        ...
        if Config.AutoJoinSettings[key] then
            ...
            Tween(box, {BackgroundColor3 = THEME.PlatformAccent}, 0.2)
        else
            lbl.TextColor3 = THEME.SubText
    ...
    if Config.AutoJoinSettings[key] then
        lbl.TextColor3 = THEME.Text
        box.BackgroundColor3 = THEME.PlatformAccent
    end
...
CWStroke.Color = THEME.PlatformAccent
...
CWScroll.ScrollBarImageColor3 = THEME.PlatformAccent
    ...
    for i, w in ipairs(list) do
        if query == "" or w:find(query, 1, true) then
            ...
            row.MouseButton1Click:Connect(function()
                ...
                Tween(row, {BackgroundColor3 = THEME.PlatformAccent}, 0.2)
...
SBStroke.Color = THEME.PlatformAccent
...
SBList.ScrollBarImageColor3 = THEME.PlatformAccent
...
SBRefresh.BackgroundColor3 = THEME.PlatformAccent
...
do
    ...
    WBStroke.Color = THEME.PlatformAccent
    ...
    WBSearchBtn.BackgroundColor3 = THEME.PlatformAccent
    ...
    WBList.ScrollBarImageColor3 = THEME.PlatformAccent
...
local function SmartType(targetWord, currentDetected, isCorrection, bypassTurn)
    ...
    Tween(StatusDot, {BackgroundColor3 = THEME.PlatformAccent})
...
SetupSlider(SliderBtn, SliderBg, SliderFill, function(pct)
    ...
    else Tween(SliderFill, {BackgroundColor3 = THEME.PlatformAccent}) end
end)
...
do
    ...
    Instance.new("UIStroke", sf).Color = THEME.PlatformAccent
    StatsData.Frame = sf
